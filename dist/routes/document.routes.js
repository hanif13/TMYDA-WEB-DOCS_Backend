...
router.get('/categories', auth_middleware_1.authenticateToken, document_controller_1.getDocumentCategories);
router.get('/', auth_middleware_1.authenticateToken, document_controller_1.getDocuments);
